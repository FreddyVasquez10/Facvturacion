...
echo "Los datos del registro de Proveedores son los siguientes:    <p>";
...
echo "Fecha de Cumpleaños: $fecha_cumple <p>";
      $conectar=conn();
      $sql="INSERT INTO proveedores (nombre,nit,e_mail,telefono,direccion,pais,ciudad,fecha_cumple) 
